// ======================================================================
// Greengarden.v generated from TopDesign.cysch
// 01/15/2018 at 14:55
...
module top ;
	...
	wire [0:0] tmpOE__Pin_Moisture_Sensor_net;
	wire [0:0] tmpFB_0__Pin_Moisture_Sensor_net;
	wire [0:0] tmpIO_0__Pin_Moisture_Sensor_net;
	electrical [0:0] tmpSIOVREF__Pin_Moisture_Sensor_net;

	cy_psoc3_pins_v1_10
		#(.id("e384f3c8-4aab-44c3-bd2e-4d4b0c4a9d0f"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Moisture_Sensor
		 (.oe(tmpOE__Pin_Moisture_Sensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Moisture_Sensor_net[0:0]}),
		  .io({tmpIO_0__Pin_Moisture_Sensor_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Moisture_Sensor_net),
		  .interrupt({Net_87}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Moisture_Sensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_pump_net;
	wire [0:0] tmpFB_0__Pin_pump_net;
	wire [0:0] tmpIO_0__Pin_pump_net;
	wire [0:0] tmpINTERRUPT_0__Pin_pump_net;
	electrical [0:0] tmpSIOVREF__Pin_pump_net;

	cy_psoc3_pins_v1_10
		#(.id("17889f3f-8dfb-41a9-83df-2a5045e4151b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_pump
		 (.oe(tmpOE__Pin_pump_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_pump_net[0:0]}),
		  .io({tmpIO_0__Pin_pump_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_pump_net),
		  .interrupt({tmpINTERRUPT_0__Pin_pump_net[0:0]}),
		  .annotation({Net_91}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_pump_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Light_Sensor_net;
	wire [0:0] tmpFB_0__Pin_Light_Sensor_net;
	wire [0:0] tmpIO_0__Pin_Light_Sensor_net;
	electrical [0:0] tmpSIOVREF__Pin_Light_Sensor_net;

	cy_psoc3_pins_v1_10
		#(.id("20e46925-ea28-47fd-891c-6825fa1d33dd"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Light_Sensor
		 (.oe(tmpOE__Pin_Light_Sensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Light_Sensor_net[0:0]}),
		  .io({tmpIO_0__Pin_Light_Sensor_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Light_Sensor_net),
		  .interrupt({Net_86}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Light_Sensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		Pin_Moisture_Sensor_int
		 (.int_signal(Net_87));


    cy_annotation_universal_v1_0 RELAY (
        .connect({
            Net_91,
            Net_88,
            Net_92,
    ...
    defparam RELAY.comp_name = "Relay_v1_0";
    defparam RELAY.port_names = "C1, C2, NC1, NC2, NO1, NO2, T1, T2";
    defparam RELAY.width = 8;
    ...
    cy_annotation_universal_v1_0 pump (
        .connect({
            Net_92,
            Net_101
        })
    );
    defparam pump.comp_name = "Motor_v1_0";
    defparam pump.port_names = "T1, T2";
    defparam pump.width = 2;
