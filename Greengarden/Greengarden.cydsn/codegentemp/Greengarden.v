...
module top ;
	...
	wire [0:0] tmpINTERRUPT_0__Pin_Moisture_Sensor_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Moisture_Sensor
		 (.oe(tmpOE__Pin_Moisture_Sensor_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Pin_Moisture_Sensor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
